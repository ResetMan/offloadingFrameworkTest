...
//	}
	...
	public static byte[][] Math(byte[] oriBmpbs) {

		Bitmap oriBmp = Tools.Bytes2Bitmap(oriBmpbs);
		...
		byte[] bitmap1bs = Tools.Bitmap2Bytes(bitmap1);
		byte[] bitmap2bs = Tools.Bitmap2Bytes(bitmap2);
		byte[] bitmap3bs = Tools.Bitmap2Bytes(bitmap3);
		byte[] bitmap4bs = Tools.Bitmap2Bytes(bitmap4);
		byte[] bitmap5bs = Tools.Bitmap2Bytes(bitmap5);
		byte[] bitmap6bs = Tools.Bitmap2Bytes(bitmap6);
		byte[] bitmap7bs = Tools.Bitmap2Bytes(bitmap7);

		return new byte[][] { bitmap1bs, bitmap2bs, bitmap3bs, bitmap4bs, bitmap5bs, bitmap6bs, bitmap7bs };
	}
}